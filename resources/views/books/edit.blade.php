        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="card bg-gray-300 shadow-xl space-y-6 p-6">
                ...
                <form method="POST" action="/books/{{ $book->id }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                        <label for="cover_image" class="block text-sm font-medium text-gray-900">Upload New Cover Image (max 12MB)</label>
                        <input type="file" name="cover_image" id="cover_image" class="rounded-lg w-full mt-2" accept="image/png, image/jpeg" onchange="validateFileSize(this)">
