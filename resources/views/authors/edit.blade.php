    ...
    <div class="py-12 px-1">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="card bg-gray-300 shadow-xl space-y-6 p-6">
                ...
                <form method="POST" action="/authors/{{ $author->id }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                        <label for="photo" class="block text-sm font-medium text-gray-900">Upload New Author Photo (max 12MB)</label>
                        <input type="file" name="photo" id="photo" class="rounded-lg w-full mt-2" accept="image/png, image/jpeg" onchange="validateFileSize(this)">
